...
describe('competition refresh', () => {
  it('does not restore an old catalogue after the credential changes', async () => {
    ...
    window.halfspace = {
      ...
      sportmonks: {
        refreshPlayerDirectory: vi.fn(),
        refreshCountryCompetitions: vi.fn(),
        refreshTeamSeasons: vi.fn(),
        refreshTeamDirectory: vi.fn(),
        refreshTeamSchedule: vi.fn(),
        refreshSeasonReferees: vi.fn(),
        refreshSeasonVenues: vi.fn(),
        refreshStandingCorrections: vi.fn(),
        refreshTransferRumours: vi.fn(),
        refreshCompetition: vi.fn(),
        refreshSeasonTeams: vi.fn(),
        refreshTeamCompetitions: vi.fn(),
        refreshLiveStandings: vi.fn(),
        refreshFixtureTrends: vi.fn(),
        refreshTvGuide: vi.fn(),
        refreshBroadcaster: vi.fn(),
        refreshBroadcastSchedule: vi.fn(),
        refreshSubscription: vi.fn(),
        refreshStatisticSeasons: vi.fn(),
        refreshSeasonBracket: vi.fn(),
        refreshExpectedLineups: vi.fn(),
        refreshFixtureExpectedMetrics: vi.fn(),
        refreshFixturePredictions: vi.fn(),
        refreshFixturePeriodStatistics: vi.fn(),
