...
export const subscriptionFeatures = [
  ...
  { key: 'expected-lineups', name: 'Expected lineups', resourceIds: [142], enrichmentId: 155 },
  { key: 'xg', name: 'Expected goals', resourceIds: [142], enrichmentId: 143 },
  { key: 'predictions', name: 'Match predictions', resourceIds: [220], enrichmentId: 124 },
