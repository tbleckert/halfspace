...
| Credential lifecycle | Invalidate pending search/refresh work, reset the mounted workspace, gate it during cache clearing, surface reset failures with retry, and reject stale rate-limit snapshots. | Credential flow and deferred-response tests.                                                                                                        |
